...
### Added
- **Temperature parameter** - New `--temperature` flag to test with production-like settings (default: 0.0)
- Temperature displayed in CLI output for clarity

### Fixed
- `.env` file loading now works correctly when running ruvrics from any directory (uses `find_dotenv`)
